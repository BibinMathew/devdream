    ...
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                ...
                backButtonText: '&raquo; Previous',
                completeQuizText: '',
                tryAgainText: '',
                questionCountText: 'Question %current of %total',
                preventUnansweredText: 'You must select at least one answer.',
                questionTemplateText:  '%text',
                questionImageTemplateText:  '%image %text',
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        var formatQuestion = '';
                       if(question.image!=""){
                            formatQuestion = plugin.config.questionImageTemplateText
                                .replace('%image', '<img src="http://idreamias.com/assets/uploads/files/dqImage/'+question.image+'" />').replace('%text', question.q);
                            }
                            else{
