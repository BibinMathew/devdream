...
class Topichome extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->helper('url');
         $this->load->model('currart/topic_model');
    ...
    public function manage() {
        ...
        $this->grocery_crud->set_table('dreamon_currentaffairstopic');
        $this->grocery_crud->set_relation('catopic_parentid', 'dreamon_currentaffairstopic', 'catopic_name');
