        ...
        <div class="uk-container-center" style="font-family:'bebasregular';font-size:18px;margin-top:20px;">
            ...
            <div class="uk-grid">
                ...
                <div class="uk-width-2-4">
                    ...
                    echo form_open('authentication/User_Authentication/forgotpasswordform');
                    ?>
                    <?php
                    ...
                    <div class="uk-form-row">
                        <input class="uk-width-1-1 uk-form-large" type="text"  name="Email" placeholder="User Email">
                    </div>
