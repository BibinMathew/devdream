 ...
 */
require(['ojs/ojcore', 'knockout', 'jquery', 'app', 'ojs/ojmodel', 'ojs/ojknockout', 'ojs/ojknockout-model', 'ojs/ojbutton', 'ojs/ojtoolbar','ojs/ojmenu'], // add additional JET component modules as needed
  function(oj, ko, $, app) // this callback gets executed when all required modules are loaded
  {
      // add any startup code that you want here
      $(document).ready(function(){
        var vm = new app.empVM();
            vm.fetch(
                function(collection, response, options){
                  var empData = collection;
                  // This will create a ko.observable() for each element
                  // in the empData response and assign the resulting array
                  // to the Employees ko observeableArray.
                  vm.Employees = oj.KnockoutUtils.map(empData, null, true);
